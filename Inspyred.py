...
def solution_evaluation(L, S):
    ...
    print("Tempo de utilizacao semanal maquina (MAX 60h): ", float((6*L + 5*S) / 100))
    print("Espaco utilizado do deposito (MAX. 1500)", float(10*L + 20*S))
    print("Producao de Garrafas tipo LEITE produzidas (MAX. 800): ", L)
    print("Producao de garrafas do tipo SUCO produzidas (MAX .750): ", S)
